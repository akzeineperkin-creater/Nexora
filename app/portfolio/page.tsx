          ...
          <table className="w-full text-left text-xs">
            <thead>
              <tr className="bg-slate-50 dark:bg-[#1E1E21] border-b border-slate-border dark:border-[#3A3A3D] text-slate-muted dark:text-[#A1A1AA] uppercase text-[10px] font-bold tracking-wider select-none">
                ...
                <th className="py-3 px-4 text-center">Trend Chart</th>
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-[#3A3A3D]">
              {isLoading ? (
                    ...
                    >
                      ...
                      <td className="py-3.5 px-4">
                        <Link href={`/markets/${ticker}`} className="flex items-center gap-3">
                          ...
                          <div>
                            <div className="font-extrabold text-slate-dark dark:text-[#F5F5F5] text-sm group-hover:text-lime-900 dark:group-hover:text-lime transition-colors">
                              {ticker}
                            </div>
                            <div className="text-[11px] text-slate-muted dark:text-[#71717A] truncate max-w-[160px]">{name}</div>
                          </div>
                        </Link>
                      </td>

                      {/* Quantity */}
                      <td className="py-3.5 px-4 font-mono font-bold text-slate-dark dark:text-[#F5F5F5] text-right text-xs">
                        {h.shares}
                      </td>

                      {/* Average Purchase Price */}
                      <td className="py-3.5 px-4 font-mono text-slate-600 dark:text-[#A1A1AA] text-right">
                        {formatCurrency(h.average_buy_price)}
                      </td>

                      {/* Current Market Price */}
                      <td className="py-3.5 px-4 font-mono font-bold text-slate-dark dark:text-[#F5F5F5] text-right">
                      ...
                      <td className="py-3.5 px-4 font-mono font-black text-slate-dark dark:text-[#F5F5F5] text-right text-sm">
                      ...
                      {/* Interactive Mini Performance Chart */}
                      <td className="py-3.5 px-4 text-center">
                        <button
                          type="button"
                          onClick={() => setSelectedHoldingTicker(isSelected ? null : ticker)}
                          className="p-1 rounded-lg hover:bg-slate-100 dark:hover:bg-[#323236] transition-colors inline-flex items-center gap-1 text-slate-500 dark:text-[#71717A] hover:text-slate-dark dark:hover:text-[#F5F5F5] cursor-pointer"
                          title="View Interactive Chart"
                        >
                          <Sparkline isPositive={h.isPositive} width={65} height={20} />
                          {isSelected ? <ChevronUp className="w-3 h-3 text-slate-600 dark:text-[#F5F5F5]" /> : <ChevronDown className="w-3 h-3 text-slate-400 dark:text-[#71717A]" />}
                        </button>
                      </td>
                      ...
                      <td className="py-3.5 px-4 text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          <Link href={`/trade?ticker=${ticker}&type=SELL`}>
                            <Button variant="outline" size="xs">Sell</Button>
                          </Link>
                        </div>
                      </td>
                    </tr>
                ...
                <tr>
                  <td colSpan={10} className="text-center py-12 text-slate-muted dark:text-[#71717A]">
                    <div className="flex flex-col items-center gap-2 max-w-sm mx-auto">
                      ...
                      <span className="text-[11px] text-slate-400 dark:text-[#71717A]">
                        Use your simulated $10,000.00 virtual cash to buy US stocks & ETFs in real-time.
                      </span>
