          ...
          <table className="w-full text-left text-xs border-collapse">
            <thead>
              <tr className="bg-slate-50 dark:bg-[#1E1E21] border-b border-slate-border dark:border-[#3A3A3D] text-slate-muted dark:text-[#A1A1AA] uppercase text-[10px] font-bold tracking-wider select-none">
                ...
                <th className="py-3 px-2 sm:px-4 text-right hidden sm:table-cell">Shares</th>
                <th className="py-3 px-2 sm:px-4 text-right hidden md:table-cell">Execution Price</th>
                <th className="py-3 px-2 sm:px-4 text-right hidden lg:table-cell">Current Price</th>
                <th className="py-3 px-2 sm:px-4 text-right hidden md:table-cell">Price Change %</th>
                <th className="py-3 px-2 sm:px-4 text-right">Total Value</th>
                <th className="py-3 px-2 sm:px-4 text-right hidden xl:table-cell">Cash Before</th>
                <th className="py-3 px-2 sm:px-4 text-right hidden xl:table-cell">Cash After</th>
                <th className="py-3 px-2 sm:px-4 text-right">Realized / Unrealized P&L</th>
                <th className="py-3 px-2 sm:px-4 text-right hidden lg:table-cell">Remaining Position</th>
                <th className="py-3 px-2 sm:px-4 hidden sm:table-cell">Order Type</th>
                <th className="py-3 px-2 sm:px-4 hidden md:table-cell">Timestamp (UTC)</th>
                <th className="py-3 px-2 sm:px-4 text-center">Status</th>
              </tr>
            </thead>
                ...
                <tr>
                  <td colSpan={14} className="text-center py-12 px-4 text-slate-muted dark:text-[#71717A] font-sans">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <span className="font-semibold text-xs text-slate-600 dark:text-[#A1A1AA]">No transactions matched your filter.</span>
                      <span className="text-[11px] text-slate-400 dark:text-[#71717A]">Try resetting your search query or placing a new trade order.</span>
                      <Link href="/trade" className="mt-2">
                        <Button variant="lime" size="xs">
                          <PlusCircle className="w-3.5 h-3.5 mr-1" />
                          <span>Open Order Terminal</span>
                        </Button>
                      </Link>
                    </div>
                  </td>
